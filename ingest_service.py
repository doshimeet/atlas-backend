...
from wbg_client import fetch_live_wbg_publications, THEMATIC_PRACTICES
...
class HybridSemanticaIngestionWorker:
    ...
    def __init__(self):
        ...
        self.client_headers = {
            "User-Agent": "Mozilla/5.0 (AtlasKnowledge/3.0; World Bank Open Knowledge Repository) Chrome/120.0.0.0",
    ...
    async def ingest_single_publication(self, paper: Dict[str, Any], db) -> Dict[str, Any]:
        ...
        try:
            ...
            manifest.sha256_hash = sha256_hash
            manifest.total_bytes = len(pdf_bytes)
            ...
            manifest.parsed_sections = len(parsed_doc.sections)
            ...
            # 5. Extract Real W3C PROV-O Semantic Triplets (Zero Hardcoding)
