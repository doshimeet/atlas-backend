...
class LocalStorageProvider(StorageProvider):
    """
    Local Lakehouse filesystem implementation for macOS development.
    Stores files in ./data/lakehouse/
    """
...
class AzureADLSGen2Provider(StorageProvider):
    ...
    """
    def __init__(self):
        self.account_name = os.getenv("AZURE_STORAGE_ACCOUNT", "atlaslakehouse")
        self.file_system = os.getenv("AZURE_STORAGE_CONTAINER", "wbg-knowledge-lakehouse")
...
def get_storage_provider() -> StorageProvider:
    """
    Factory creating the active storage provider based on STORAGE_PROVIDER env var.
    """
